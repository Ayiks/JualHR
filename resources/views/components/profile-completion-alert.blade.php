            ...
            <div class="flex-1 min-w-0">
                <div class="flex items-center justify-between gap-4">
                    ...
                    <a href="{{ route('employee.profile.edit') }}"
                       class="flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 bg-yellow-600 text-white text-xs font-medium rounded-lg hover:bg-yellow-700 transition-colors">
